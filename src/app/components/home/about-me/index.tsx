          ...
          <div className="container">
            ...
            <div className="pt-10 xl:pt-16 flex gap-10 items-center justify-between">
              ...
              <div className="w-full lg:max-w-2xl flex-1">
                <p>
                  Adaptable professional with 1.5 years at Divami Design Pvt
                  Ltd, making substantial contributions to the Synopsys project
                  using Angular. An enthusiastic person with high optimism and
                  leadership skills. Eager to learn and implement new
                  technologies and methodologies. Always willing to innovate new
